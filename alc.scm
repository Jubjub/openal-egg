...
___declare(substitute, "^(ALC_|alc);alc:")

/** ALC boolean type. */
___declare(type, "ALCboolean;bool")
...
ALCAPI char *  ALCAPIENTRY alcGetString(ALCdevice *device,ALCenum param);
ALCAPI ALCvoid    ALCAPIENTRY alcGetIntegerv(ALCdevice *device,ALCenum param,ALCsizei size,ALCint *data);

ALCAPI ALCdevice* ALCAPIENTRY alcOpenDevice(char *deviceName);
...
ALCAPI ALCboolean ALCAPIENTRY alcIsExtensionPresent(ALCdevice *device,char *extName);
ALCAPI ALCvoid *  ALCAPIENTRY alcGetProcAddress(ALCdevice *device,char *funcName);
ALCAPI ALCenum	  ALCAPIENTRY alcGetEnumValue(ALCdevice *device,char *enumName);
